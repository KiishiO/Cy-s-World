...
public class CounterActivity extends AppCompatActivity {
    ...
    private Button resultsBtn;  //adding a new button to link this page to DiceActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resultsBtn = findViewById(R.id.counter_results_btn);
        ...
        resultsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CounterActivity.this, DiceActivity.class);
                intent.putExtra("NUM", String.valueOf(counter));  // key-value to pass to the DiceActivity
                startActivity(intent);
            }
        });
